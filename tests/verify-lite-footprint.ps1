...
Assert-FileContains -Path 'README.md' -Needle '完整 HTML 页面只有用户明确要求或 paired reading HTML 触发时才生成'
...
Assert-FileContains -Path 'skills/md-html/SKILL.md' -Needle '完整 HTML 页面只有用户明确要求或 paired reading HTML 触发时才生成'
