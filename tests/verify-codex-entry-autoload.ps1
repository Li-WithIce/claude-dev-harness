...
Need-Text $entryContractPath '`v2_entry_activation`: `explicit-v2-only`'
...
Need-Text 'agent-configs/codex/AGENTS.md.template' 'The resolved workspace''s `AGENTS.md` and Harness runtime are authoritative'
Need-Text 'agent-configs/codex/AGENTS.md.template' 'Use `scripts\task.ps1 status` for read-only v2 recovery'
...
Need-Text 'agent-configs/workspace/AGENTS.md.template' 'Use `scripts\task.ps1 status` for a read-only v2 recovery view'
