...
$expectedCoreScripts = @(
    ...
    'run-scenario-evals.ps1','verify-model-eval-runner.ps1','verify-rollout-evidence.ps1','verify-v1-stop-loss-qualification.ps1','verify-host-benchmark-runner.ps1',
    'verify-host-benchmark-otel.ps1','verify-host-benchmark-qualification.ps1','verify-release-runner-boundary.ps1','verify-release-isolation-qualification.ps1','verify-ordinary-ci-receipt.ps1','verify-v2-ci-routing.ps1',
...
$expectedGroupSizes = [ordered]@{'entry-lifecycle'=14;'evaluation-release'=11;'install-evidence'=3;'governance-approval'=3;'harness-contracts'=15}
