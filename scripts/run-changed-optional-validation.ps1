...
$definitions = @(
    ...
    [ordered]@{name='thin-trust-kernel';patterns=@('docs/architecture/*','kernel-tcb-*.json','kernel-component-classification.json','schemas/*kernel*','schemas/module-manifest.schema.json','scripts/get-kernel-tcb-inventory.ps1','tests/fixtures/tk00/*','tests/verify-*kernel*');tests=@('verify-kernel-tcb-inventory.ps1','verify-thin-trust-kernel-contracts.ps1')},
