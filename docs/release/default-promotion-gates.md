...
DP-02A stops at the Rollout v2 core boundary above. The bounded DP-02B implementation adds the Installed Desktop producer/authority contract and G03/G07 portable Adapter only; formal core/governed/full lifecycle aggregation, current-branch release routing, remaining Adapters, and real release inputs remain separately authorized DP-02C work.
