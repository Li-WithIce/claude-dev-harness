...
DP-02A stops at the Rollout v2 core boundary above. The bounded DP-02B implementation adds the Installed Desktop producer/authority contract and G03/G07 portable Adapter only. The bounded lifecycle portion of DP-02C adds the strict core/governed/full producer and G18/G19/G20 portable Adapters; current-branch release routing, aggregation, remaining Adapters, and real release inputs remain separate work.
